...
| `s3.warehouseDir`                        | string            | true      | `s3a://{{ .Release.Namespace }}-warehouse/hive` unless a custom path is provided in `s3.warehouseDir`                                                                                                    | The directory in S3 storage, where Hive-Metastore should store its data.                                                                                                                                                                                                                                                                                |
...
| `hive.db`                                | string            | false     | `{{ .Release.Namespace }}_db` unless a custom database name is provided in `hive.db`                                                                                                            | The Hive Metastore database created in PG by `hiveInitJob`.                                                                                                                                                                                                                                                                                             |
